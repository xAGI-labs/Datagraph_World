    ...
    return (
      <div className="min-h-screen bg-gradient-to-bl from-amber-50 via-gray-50 to-orange-100/40 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Please verify your World ID to access vibe points trading.</p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-bl from-amber-50 via-gray-50 to-orange-100/40 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading your vibe points...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Vibe Points Trading</h1>
            <p className="text-xl text-gray-600">Trade your earned vibe points for WLD and USDC</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <Card className="p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Trade Vibe Points</h3>
              </div>
            ...
            <Card className="p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Conversion Rates</h3>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="text-gray-600">1000 points = 1 WLD</span>
                </div>
                ...
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="text-gray-600">1000 points = 1 USDC</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-green-600">{userStats?.comparisonsCompleted || 0}</p>
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Day Streak</h3>
              <p className="text-2xl font-bold text-blue-600">{userStats?.dayStreak || 0}</p>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-purple-600">{userStats?.paymentStats?._count?.id || 0}</p>
          ...
          <Card className="p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Need More Vibe Points?</h2>
          ...
          <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">How Vibe Points Trading Works</h3>
